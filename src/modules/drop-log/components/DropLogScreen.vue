<template>
  <main class="mx-auto flex min-h-screen w-full max-w-md flex-col gap-3 px-3 pb-28 pt-3">
    <header class="glass-panel flex items-center justify-between rounded-2xl px-4 py-3">
      ...
      <button class="rounded-xl border border-slate-300/80 bg-white/60 px-3 py-1.5 text-sm text-slate-700 dark:border-slate-600 dark:bg-slate-900/70 dark:text-slate-200" @click="ui.toggleTheme()">
        {{ ui.isDarkMode ? "Light" : "Black" }}
      </button>
    </header>
