  ...
  <section class="space-y-2">
    <div class="grid grid-cols-2 gap-2">
      <article class="glass-panel rounded-2xl p-3">
        <h3 class="text-xs text-slate-600 dark:text-slate-400">Top mood</h3>
        <p class="text-lg font-semibold text-slate-900 dark:text-slate-100">{{ topMood }}</p>
      </article>
      <article class="glass-panel rounded-2xl p-3">
        <h3 class="text-xs text-slate-600 dark:text-slate-400">Total days active</h3>
    ...
    <article class="glass-panel rounded-2xl p-3">
      <div class="flex items-center justify-between">
        ...
        <span class="text-[11px] text-slate-600 dark:text-slate-400">last 7 entries</span>
      </div>
      ...
      <p class="mt-2 text-xs text-slate-700 dark:text-slate-300">{{ aiSummary }}</p>
    </article>
  </section>
</template>
